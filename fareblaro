...
# See dokumentaro/readme.html for installation and customization instructions.
...
# Where to install. The installation starts in the fontaro and dokumentaro directories,
